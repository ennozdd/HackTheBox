...
```bash
# Nmap 7.91 scan initiated Fri Aug 27 12:34:47 2021 as: nmap -sC -sV -p- -oA nmap/swagshop -vvv 10.10.10.140
Nmap scan report for 10.10.10.140
Host is up, received echo-reply ttl 63 (0.063s latency).
Scanned at 2021-08-27 12:34:48 +03 for 84s
...
# Nmap done at Fri Aug 27 12:36:12 2021 -- 1 IP address (1 host up) scanned in 84.95 seconds
```