...
```sql
# Nmap 7.91 scan initiated Tue May 25 21:38:11 2021 as: nmap -sC -sV -p- -oA nmap/brainfuck 10.10.10.17
...
|_pop3-capabilities: UIDL TOP PIPELINING CAPA USER AUTH-RESP-CODE SASL(PLAIN) RESP-CODES
143/tcp open  imap     Dovecot imapd
|_imap-capabilities: IDLE ENABLE LITERAL+ have capabilities listed IMAP4rev1 post-login OK AUTH=PLAINA0001 Pre-login ID more LOGIN-REFERRALS SASL-IR
...
# Nmap done at Tue May 25 21:40:50 2021 -- 1 IP address (1 host up) scanned in 158.72 seconds
```

# wpscan (wp-support-plus-responsive-ticket-system vulnerability)
```sql
...
[+] Started: Wed May 26 14:05:22 2021
...
[+] Finished: Wed May 26 14:05:27 2021
[+] Requests Done: 141
[+] Cached Requests: 42
[+] Data Sent: 35.518 KB
[+] Data Received: 25.159 KB
[+] Memory used: 217.684 MB
