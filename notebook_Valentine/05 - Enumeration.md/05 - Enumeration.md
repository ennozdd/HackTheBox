...
```sql
# Nmap 7.91 scan initiated Wed May 19 15:51:14 2021 as: nmap -sC -sV -p- -vvv -oA nmap/valentine 10.10.10.79
Nmap scan report for 10.10.10.79
Host is up, received echo-reply ttl 63 (0.075s latency).
Scanned at 2021-05-19 15:51:15 +03 for 53s
...
| gRSFfyZx/VqBh9c=
|_-----END CERTIFICATE-----
|_ssl-date: 2021-05-19T12:59:03+00:00; +6m56s from scanner time.
...
# Nmap done at Wed May 19 15:52:08 2021 -- 1 IP address (1 host up) scanned in 53.48 seconds
```


# Nmap vuln scan / heartbleed vulnerability

Since this box is pretty old, nmap vuln scan should also run
```sql
# Nmap 7.91 scan initiated Wed May 19 20:02:53 2021 as: nmap --script vuln -oA nmap/vuln 10.10.10.79
...
# Nmap done at Wed May 19 20:03:28 2021 -- 1 IP address (1 host up) scanned in 34.99 seconds
```
