# 10 - Jail
![](vx_images/3287110178892.png)

# Gobuster

```bash
┌─[user@parrot]─[10.10.14.12]─[~/htb/jail]
└──╼ $ gobuster dir -u http://10.10.10.34 -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -o gobuster/jail.log -t 100
/jailuser             (Status: 301) [Size: 236] [--> http://10.10.10.34/jailuser/]
```

# Dev
![](vx_images/4574721736415.png)

![](vx_images/869731525507.png)
